...
from app.generated.project import project_pb2 as project_dot_project__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in project/project_pb2_grpc.py depends on'
...
class ProjectServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetProjectById = channel.unary_unary(
                ...
                response_deserializer=project_dot_project__pb2.ProjectResponse.FromString,
...
def add_ProjectServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetProjectById': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=project_dot_project__pb2.ProjectResponse.SerializeToString,
            ),
    }
...
class ProjectService(object):
    ...
    def GetProjectById(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            project_dot_project__pb2.ProjectResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
